  ...
  return (
    <div className='Info'>
      ...
      <div className='img-container'>
        <strong>1. Recyclable Materials: NYC's curbside recycling program accepts the following materials:
          <br />
          <br />
          ...
          <br />
          <br />
          8. Composting: While not currently available citywide, NYC has been piloting organics recycling programs for food waste. Check with DSNY for updates on composting initiatives in your area.</strong>
        <br />
        <br />
